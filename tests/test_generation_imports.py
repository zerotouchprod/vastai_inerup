"""
Test imports for text-to-video generation module.

This test verifies that all modules can be imported without errors,
which is critical for ensuring the isolated runtime works correctly.
"""
...
def test_import_generation_modules():
    ...
    # Core modules
    from src.services.generation.config import GenerationConfig, get_generation_config
    from src.services.generation.models import GenJob, GenerationResult, BatchGenerationResult
    from src.services.generation.engine import CogVideoEngine
    ...
    assert CogVideoEngine is not None
...
def test_no_opencv_import():
    ...
    import src.services.generation.engine
