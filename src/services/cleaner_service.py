...
class SubtitleRemoverService:
    ...
    def _generate_binary_masks(self, frames_dir: Path, mask_dir: Path):
        ...
        for frame_path in frames:
            ...
            all_bboxes = bboxes_standard + bboxes_enhanced
            ...
            # --- МАКСИМАЛЬНОЕ РАСШИРЕНИЕ (Против фиолетового тумана) ---
            # Kernel 30x30 - это очень много. Это "съест" все свечение вокруг букв.
